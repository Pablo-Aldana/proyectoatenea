...
protected function leftbutton1_clickHandler(event:MouseEvent):void
{
	sections.selectedIndex=leftMenu.getChildIndex(DisplayObject(event.currentTarget));
}

protected function sections_changeHandler(event:Event):void
{
	// TODO Auto-generated method stub
	for (var i:Number=0; i<leftMenu.numChildren-2; i++)
	{
		var item:Object=leftMenu.getChildAt(i);
		item.selected=false;
	}
	var item2:Object=leftMenu.getChildAt(sections.selectedIndex);
	item2.selected=true;
}
